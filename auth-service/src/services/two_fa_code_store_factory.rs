...
pub fn redis_two_fa_code_store(redis_pool: Arc<RedisPool>, config: Arc<AppConfig>) -> TwoFACodeStoreType {
    Arc::new(RwLock::new(RedisTwoFACodeStore::new(redis_pool, config)))
}
